...
# Hardcode NetBIOS name to prevent long delays while resolving the vboxsrv 
Write-Output @'
...
# Change wallpaper, lockscreen, and hide misc buttons in explorer
...
# Disable recovery agent, else sysprep will fail
reagentc /disable
...
Copy-Item -Force E:\unattend.xml -Destination C:\
Copy-Item -Force E:\rearm.ps1 -Destination C:\
